...
public class AdminGetAllTasksUseCase {
  private final TaskRepository taskRepository;

  public PageResponse<TaskResponse> execute(TaskFilterParam filter) {
    Specification<Task> spec = TaskSpecification.buildAdminFilter(
      filter.getCompleted(),
    ...
    log.info("Admin fetched all tasks with {} elements", page.getTotalElements());
